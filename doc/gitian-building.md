...
- [Building Hyperstake](#building-cryptocraze)
...
git clone https://github.com/cryptocraze/cryptocraze
```
...
Follow the instructions in [doc/release-process.md](release-process.md) in the cryptocraze repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the cryptocraze repository.
...
Output from `gbuild` will look something like
    ...
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/cryptocraze/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/cryptocraze/cryptocraze
...
For example:
```bash
URL=https://github.com/robvanmieghem/cryptocraze.git
COMMIT=master
./bin/gbuild --commit cryptocraze=${COMMIT} --url cryptocraze=${URL} ../cryptocraze/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit cryptocraze=${COMMIT} --url cryptocraze=${URL} ../cryptocraze/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit cryptocraze=${COMMIT} --url cryptocraze=${URL} ../cryptocraze/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/cryptocraze-linux-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/cryptocraze-win-build.assert
    gpg --detach-sign ${VERSION}-osx-unsigned/${SIGNER}/cryptocraze-osx-build.assert
```
...
[cryptocraze/gitian.sigs](https://github.com/cryptocraze/gitian.sigs/) repository, or if that's not possible create a pull
