             ...
             bool& fIsEncrypted,  bool& fAnyUnordered, string& strType, string& strErr)
{
    try {
		...
		else if (strType == "stakeSplitThreshold") //presstab CryptoCraze
		{
            ssValue >> pwallet->nStakeSplitThreshold;
		}
		else if (strType == "multisend") //presstab CryptoCraze
		{
			unsigned int i;
			ssKey >> i;
		...
		else if(strType == "msettings")//presstab CryptoCraze
		{
