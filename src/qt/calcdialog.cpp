...
void calcDialog::pushButtonClicked()
{
    ...
    if(nUserAmount * nTargetDays < nMedianWeight)
    {
        ...
        ui->avgWeightResult->setText(strAvgSize + QString(" It is recommended that you do not split your CRZ. %1 CRZ will yield a weight of <b>%2</b> on day %3, which is %4 less weight than the median weight staked in the last 1,000 blocks.")
    ...
    ui->avgWeightResult->setText(strAvgSize + QString(" It is recommended that you split your %1 CRZ into <b>%2 outputs of %3 CRZ</b>. This will yield a weight of <b>%4</b> on day %5.")
                            .arg(us.toString(nUserAmount))
