...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. CryptoCraze can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "CryptoCraze",
    ...
    try {
        ...
        QMessageBox::critical(0, QObject::tr("CryptoCraze"),
    ...
    app.setOrganizationName("CryptoCraze");
    app.setOrganizationDomain("CryptoCraze.su");
